...
def construct_model(model, num_classes=10, seed=None, num_channels=3, modelkey=None):
    ...
    elif model == 'ResNet32-10-metric':
        model = ResNet_Metric(torchvision.models.resnet.BasicBlock, [5, 5, 5], num_classes=num_classes, base_width=16 * 10)
    elif model == 'ResNet44':
...
class ResNet(torchvision.models.ResNet):
    ...
    def _forward_impl(self, x):
        ...
        x = self.fc(x)
        return x
class ResNet_Metric(torchvision.models.ResNet):
    """ResNet generalization for CIFAR thingies."""
...
class AlexNet(nn.Module):
    '''AlexNet for Cifar10 from https://github.com/rasbt/deeplearning-models/blob/master/pytorch_ipynb/cnn/cnn-alexnet-cifar10.ipynb'''
